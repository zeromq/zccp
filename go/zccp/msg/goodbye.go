...
// New creates new Goodbye message.
...
func (g *Goodbye) Marshal() ([]byte, error) {
	...
	binary.Write(buffer, binary.BigEndian, GoodbyeId)
...
func (g *Goodbye) RoutingId() []byte {
	return g.routingId
}

// SetRoutingId sets the routingId for this message, routingId should be set
// whenever talking to a ROUTER.
func (g *Goodbye) SetRoutingId(routingId []byte) {
